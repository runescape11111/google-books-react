...
function SearchForm({handleInputChange, searchBooks}) {
    return (
                ...
                <form onSubmit={searchBooks}>
                    <div className="form-group row">
                        <div className="d-flex col-12 col-md-9 col-lg-10 col-xl-10 pt-3">
                            <input type="text" className="form-control flex-grow-1 mx-3" id="search-book" placeholder="Search a book" onChange={handleInputChange} />
                        </div>
